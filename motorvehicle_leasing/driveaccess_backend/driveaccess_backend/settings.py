"""
Django settings for driveaccess_backend project.
...
SECRET_KEY = 'django-insecure-nde$rjo#t^1ny$3onh+_95ijcw%vsgg6(l7la(8%u!a#gni28&'
...
ROOT_URLCONF = 'driveaccess_backend.urls'
...
WSGI_APPLICATION = 'driveaccess_backend.wsgi.application'
