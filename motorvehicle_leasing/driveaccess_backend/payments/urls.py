...
urlpatterns = [
    ...
    path('payments/<uuid:payment_id>/approve/', PaymentApprove.as_view(), name='payment-approve'),
    path('payments/<uuid:payment_id>/reject/', PaymentReject.as_view(), name='payment-reject'),
]